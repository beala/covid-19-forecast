...
## There continue to be no large outbreaks outside of China
The longer there are no outbreaks detected outside of China, the less likely it’s true that there are undetected outbreaks. An outbreak can only go undetected for so long. At some point, it becomes more likely that containment is in fact working. If our estimate of the number of undetected cases goes over 1,000 in several countries, it’s likely our estimate is wrong and our main evidence in favor of pandemic is likely false. This would substantially change our outlook.

For instance, assuming there have been around 20 undetected cases in Cambodia as import rates would suggest, with an incubation period of 7 days and R0 of 2.5, there would be at least 1,000 cases after about 30 days (not counting additional imports). If we don’t see outbreaks in Cambodia, Japan, or Thailand after mid-March 2020, it will seem much more likely that the virus is being contained.
